export async function onRequest(context) {
  try {
    ...
    return new Response(JSON.stringify({ source:["google","reddit","youtube","amazon","evergreen"], count: niches.length, niches }), {
      headers: { "Content-Type":"application/json" }
    });
  } catch (e) {
    return new Response(JSON.stringify({ source:["fallback"], niches:["Drones","AI tools","Pets","Fitness"] }), {
      headers: { "Content-Type":"application/json" }
    });
  }
}
